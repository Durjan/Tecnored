...
Route::group(['middleware' => ['permission:Clientes']], function () {
    ...
    Route::get('cliente/ordenes_cliente',[App\Http\Controllers\ClientesController::class ,'get_ordenes_cliente'])->middleware('permission:Ordenes')->name('cliente.ordenes_cliente');
    ...
    Route::get('cliente/suspensiones_cliente',[App\Http\Controllers\ClientesController::class ,'get_suspensiones_cliente'])->middleware('permission:Suspensiones')->name('cliente.suspensiones_cliente');
    ...
    Route::get('suspensiones/get',[App\Http\Controllers\SuspensionController::class ,'get_Suspensiones'])->middleware('permission:Suspensiones')->name('suspensiones.getsuspensiones');
...
Route::group(['middleware' => ['permission:Reportes']], function () {
    ...
    //ruta para descargar facturas exce
    Route::get('descargar/excel/{tipo_reporte}/{tipo_pago}/{id_cobrador}/{fecha_i}/{fecha_f}',[App\Http\Controllers\ReportesController::class ,'descargar_excel'])->middleware('permission:reporte_cliente')->name('reportes.descargar');
